realm = [
  ...
  [
    ...
    'locked in a forgotten basement',
    'in this sacred temple',
    'in this desolate fortress',
    'in this secured room',
    'part of a greater altar',
    'that once looked like a regular door',
    'hidden behind a waterfall',
    'at the end of a long cave system',
    'at the top of a dormant volcano',
    'hidden in plain sight in an alley',
    'formed by two bended trees',
    'that looked like a small pond before',
    'at the top of a pyramid',
    'resembling a star gate',
    'resembling a campfire',
    'at the end of a hallway',
    'seemingly disguised as a cave entrance',
    'hidden high atop a mountain among a layer of clouds',
    'part of long forgotten ruins',
    'revealed only by fire',
    'revealed only during a full moon',
    'revealed only with the right elements',
    'previously locked behind intricate locks and traps',
    'hidden in plain sight in a public park',
  ],
  [
    # positive
    'a depressing',
